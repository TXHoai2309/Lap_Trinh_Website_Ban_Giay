...
namespace BTL_LapTrinhWeb
{
    public partial class Women : System.Web.UI.Page
    {
        ...
        {
            List<Products> womenProducts = (List<Products>)Application["WomenProductList"];
            if (womenProducts == null) return;

            IEnumerable<Products> processedProducts = womenProducts;
