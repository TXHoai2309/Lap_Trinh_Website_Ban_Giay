<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sale.aspx.cs" Inherits="BTL_LapTrinhWeb.Sale" %>
        ...
        <header class="header_container">
            ...
            <nav class="menu">
                <ul id="menu_list">
                    ...
                    <li><a href="#" class="menu_item">Sale</a></li>
                </ul>
            </nav>
        </header>
        ...
        <main class="product">
            <aside class="product_user_actions">
                ...
                <div class="shop_by_item">
                    <b>Shop by item</b>
                    <ul>
                        <li class="type_shoes"><asp:LinkButton ID="btnAll" runat="server" Text="All" OnClick="btnCategory_Click" CommandArgument="All" /></li>
                        <li class="type_shoes"><asp:LinkButton ID="btnSneakers" runat="server" Text="Sneakers" OnClick="btnCategory_Click" CommandArgument="Sneakers" /></li>
                        <li class="type_shoes"><asp:LinkButton ID="btnBoots" runat="server" Text="Boots" OnClick="btnCategory_Click" CommandArgument="Boots" /></li>
                        <li class="type_shoes"><asp:LinkButton ID="btnSports" runat="server" Text="Sports" OnClick="btnCategory_Click" CommandArgument="Sports" /></li>
                        <li class="type_shoes"><asp:LinkButton ID="btnLifestyles" runat="server" Text="Lifestyles/Casual" OnClick="btnCategory_Click" CommandArgument="Lifestyles/Casual" /></li>
                    </ul>
                </div>
            </aside>
                                ...
                                <div class="product_item">
                                    <div class="product_top">
                                       ...
                                       <asp:ImageButton runat="server" CssClass="favorite_icon"
                                            CommandArgument='<%# Eval("ProductID") + "," + Eval("Gender") %>' 
                                            OnClick="btnAddToFavorites_Click"
                                            ImageUrl='<%# IsFavorite(Eval("ProductID").ToString(), Eval("Gender").ToString()) ?
                                                "~/Assets/images/Chung/icon_favorite_green.png" : 
                                                "~/Assets/images/Chung/icon_favorite.png" %>' />
